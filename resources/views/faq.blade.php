                    ...
                    <div class="faq-wrapper">
                        ...
                        <div class="t1" style="display: block;">
                            ...
                            <div class="faq_array">
                                ...
                                <div id="panel3">
                                    «FUTURE TRADE BITCOIN MINING LTD» предоставляет свои услуги всем заинтересованным
                            ...
                            <div class="faq_array">
                                ...
                                <div id="panel4">
                                    «FUTURE TRADE BITCOIN MINING LTD» предоставляет уникальную платформу Доверительного
                                    Управления инвестиционными средствами, на базе которой реализована бизнес-модель,
                                    которая практически полностью гарантирует безубыточность вложений. Это стало
                                    возможным благодаря разработанному компанией комплексу мер, дающих возможность
                                    гарантировать каждому нашему инвестору стабильные выплаты и полное соблюдение
                                    декларируемых компанией инвестиционных обязательств перед своими инвесторами.
                                </div>
                            </div>
                            <div class="faq_array">
                            ...
                            <div class="faq_array">
                                ...
                                <div id="panel6">
                                    Для каждого нашего инвестора предусмотрена возможность использования и создания
                                    только одного аккаунта. Пожалуйста, не создавайте несколько аккаунтов, ведь наша
                                    система безопасности заблокирует все ваши аккаунты без права вывода средств.
                                </div>
                                z
                            </div>
                            <div class="faq_array">
