...
@section("content")
    <div class="container my-2 ajax-page">
        ...
        <h2 class="text-center">Создать платёж для {{$user_login}}</h2>
        <form action="{{action('Admin\ActionController@retrofitting', $user_id)}}" method="post" class="ajax-form">
            ...
            <div class="text-right">
                <button type="submit" class="btn btn-primary">Создать платёж</button>
            </div>
        </form>

        <h2 class="text-center">Все пополнения пользователя</h2>
            ...
            <table class="table text-center">
                ...
                @foreach($payments as $payment)
                    <tr>
                        ...
                        <td>
                            <a href="{{action('Admin\ActionController@removePayment', [$payment->id])}}">Удалить</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
